...
export default function SignUpPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const data = await apiProxyPost<{ user?: { id: string; email?: string }; session?: { access_token: string; refresh_token?: string; expires_at?: number } }>("api/v1/auth/signup", { email, password });
      ...
      <div className="min-h-screen w-full bg-zinc-900">
        ...
        <main className="relative z-10 mx-auto max-w-7xl px-6 py-24 md:px-12 lg:px-16">
          <div className="max-w-md">
            ...
            <h1 className="text-4xl font-normal tracking-tight text-white">Sign up</h1>
            <p className="mt-2 text-zinc-400">Create a Stone Age account.</p>
