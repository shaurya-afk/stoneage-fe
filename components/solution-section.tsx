...
import { Brain, Shield, Zap, ChevronRight, Upload, Pickaxe, FileCheck} from "lucide-react";
...
const features: Feature[] = [
  {
    ...
    title: "1 – Ingest",
    description:
      "Securely upload PDFs, images, and raw text. Stone Age normalizes formats, extracts raw content, and prepares documents for structured processing. ecosystem.",
  ...
  },
  {
    ...
    title: "2 – Extract",
    description:
      "Schema-driven AI converts unstructured content into validated, structured JSON. Every field is mapped, typed, and enforced against your defined contract.",
    icon: <Pickaxe className="w-5 h-5" />,
    image: "/extract-bg.png",
  },
  {
    id: 3,
    title: "3 – Validate",
    description:
      "Outputs are checked against strict schemas with automatic retries and correction layers. No silent drift. No malformed payloads.",
    icon: <FileCheck className="w-5 h-5" />,
    image: "/validate-bg.png",
  },
];
      ...
      <div className="max-w-7xl w-full px-6 md:px-12 lg:px-16 space-y-12">
        ...
        <div className="flex flex-col gap-4 max-w-[560px]">
          ...
          <h2 className="text-balance text-4xl md:text-5xl font-normal leading-[1.1] tracking-tight text-white">
            {"Introducing Stone Age".split(" ").map((word, i) => (
              <motion.span
                key={i}
          ...
          <p className="text-balance text-zinc-400 text-base leading-relaxed">
            A production-grade document extraction engine built for structured outputs, schema validation, and repeatable results. Unlike ad-hoc prompt pipelines, Stone Age enforces contracts between input, model, and downstream systems.
            <br />
            Structured in. Structured out. Every time.
          </p>
        </div>
