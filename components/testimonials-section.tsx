...
const testimonials = [
  {
    id: 1,
    quote:
      "Stone Age's AI sentinel detected a zero-day vulnerability in our infrastructure before any traditional security tool even flagged it. The autonomous patching feature saved us from what could have been a catastrophic breach.",
    author: "Sarah Chen",
  ...
  },
  {
    id: 2,
    quote:
      "We were drowning in false positives from our legacy firewall. Stone Age cut through the noise with surgical precision, reducing our alert fatigue by 90% while actually improving our threat detection rate.",
  ...
  },
  {
    id: 4,
    quote:
      "Implementing Stone Age was the easiest security upgrade we've ever done. The system learned our network patterns in days, not months. Now it operates like an extension of our team, catching threats we didn't even know existed.",
    author: "David Kim",
  ...
  },
  {
    id: 5,
    quote:
      "After a ransomware attack nearly crippled our operations, we needed a solution that could predict and prevent, not just react. Stone Age's predictive heuristics have stopped three major attack attempts in six months.",
  ...
  },
  {
    id: 6,
    quote:
      "Compliance audits used to be our nightmare. Stone Age automatically documents every threat detection and response action, making our SOC 2 and ISO certifications straightforward. The ROI was immediate.",
        ...
        <div className="flex flex-col gap-6 mb-16">
          ...
          <div className="flex items-center justify-between gap-8">
            <h2 className="text-balance text-4xl md:text-5xl font-normal text-white">
              {"What Security Leaders Say About Stone Age.".split(" ").map((word, i) => (
                <motion.span
                  key={i}
